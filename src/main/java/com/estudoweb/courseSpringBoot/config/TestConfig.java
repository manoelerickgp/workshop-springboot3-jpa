...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order order4 = new Order(null, Instant.parse("2020-02-11T10:50:33Z"), user5);
        Order order5 = new Order(null, Instant.parse("2019-03-14T09:44:22Z"), user4);
        Order order6 = new Order(null, Instant.parse("2019-05-18T18:25:11Z"), user6);
        Order order7 = new Order(null, Instant.parse("2019-09-19T13:19:10Z"), user7);
        Order order8 = new Order(null, Instant.parse("2019-03-09T15:58:59Z"), user3);
